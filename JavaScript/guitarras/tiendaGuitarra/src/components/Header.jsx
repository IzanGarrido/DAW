...
export default function Header({ carrito, eliminarDelCarrito, anyadirAlCarrito, quitarDelCarrito, vaciarCarrito }) {

    const carritoTotal = useMemo(() => carrito.reduce((total, element) => total + (element.cantidad * element.price), 0));
                                                    ...
                                                    <tr key={element.id}>
                                                        ...
                                                        <td className="flex align-items-start gap-4">
                                                            <button
                                                                ...
                                                                onClick={() => quitarDelCarrito(element)}
                                                            ...
                                                            <button
                                                                type="button"
                                                                className="btn btn-dark"
                                                                onClick={() => anyadirAlCarrito(element)}
